function [RouteX,RouteY] = autoGenRakeRoute2(xVertex,yVertex,HalfWidth)
% [RouteX,RouteY] = autoGenRakeRoute2(xVertex,yVertex,HalfWidth)
% 生成旋引形的探扫路径。
%   此处显示详细说明。
% 步骤：
% 1、找出最长的边；
...
% 3、计算旋转角度及新顶点位置；
% 4、调用autoGenRakeRoute函数生成弓形路径的途经点；
